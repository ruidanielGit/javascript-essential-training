...
//can also use this function but needs to be declared before its called
const lidOpen = function () {
...
const content = `
  ...
  <ul class="backpack__features">
    ...
    <li class="feature backpack__lid">Lid status:<span> ${console.log(
...
console.log(everydayPack.lidOpen ? "Opened" : "Closed");
